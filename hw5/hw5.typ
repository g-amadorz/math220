  ...
  - *Proof by Induction:*
    ...
    - *I.H.*
      ...
      $
        ...
        a_(n+1) & = 2(2a_(n-1) + a_(n-2) + a_(n-3)) + a_(n-1) + a_(n-2) \
    ...
    - *I.S.*
      ...
      $
        2^k & < a_k \
        2 dot 2^k & < 2 dot a_k \
        2^(k+1) & < 2 dot (2a_(k-1) + a_(k-2) + a_(k-3)) \
        2^(k+1) & < 4a_(k-1) + 2a_(k-2) + 2a_(k-3) \
        2^(k+1) & < 4a_(k-1) + 2a_(k-2) + 2a_(k-3) < 5a_(k-1) + 3a_(k-2) + 2a_(k-3) \
        2^(k+1) & < 5a_(k-1) + 3a_(k-2) + 2a_n(k-3) = a_(k+1) & "By Lemma" \
        2^(k+1) & < a_(k+1) \
      $
